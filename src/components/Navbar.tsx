            ...
            <div className="relative group">
              ...
              <div className="absolute top-full left-0 w-48 bg-white border border-gray-100 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform translate-y-2 group-hover:translate-y-0">
                <div className="p-2 flex flex-col">
                  <Link 
                    href="#hikes" 
                    className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-brand-green rounded-lg transition"
                  >
                    🧗 Hiking & Adventures
                  </Link>
                  <Link 
                    href="#csr" 
                    className="block px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 hover:text-brand-red rounded-lg transition"
                  >
